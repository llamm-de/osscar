...
def test_license_equality():
    license1 = License(name=LicenseName.MIT, compatible_licenses=[LicenseName.MIT, LicenseName.APACHE], copyleft=True)
    license2 = License(name=LicenseName.MIT, compatible_licenses=[LicenseName.MIT, LicenseName.APACHE], copyleft=True)
    license3 = License(name=LicenseName.GPL, compatible_licenses=[LicenseName.GPL, LicenseName.APACHE], copyleft=True)
...
def test_is_compatible_with_compatible_license():
    license1 = License(name=LicenseName.MIT, compatible_licenses=[LicenseName.MIT, LicenseName.APACHE], copyleft=True)
    license2 = License(name=LicenseName.APACHE, compatible_licenses=[LicenseName.MIT, LicenseName.APACHE], copyleft=True)
...
def test_is_compatible_with_incompatible_license():
    ...
    license2 = License(name=LicenseName.APACHE, compatible_licenses=[LicenseName.APACHE], copyleft=True)
